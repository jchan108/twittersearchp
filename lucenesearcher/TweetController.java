...
public class TweetController {
    ...
    @GetMapping("/tweets")
    public List<Tweet> searchTweets (@RequestParam(required=false, defaultValue="") String query) throws IOException, org.apache.lucene.queryparser.classic.ParseException, java.text.ParseException  {


        Analyzer analyzer = new StandardAnalyzer();
        // Now search the index:
        Directory directory = FSDirectory.open(Paths.get("/mnt/c/home/Joshua/Documents/indexTweets"));
       
        DirectoryReader indexReader = DirectoryReader.open(directory);

        IndexSearcher indexSearcher = new IndexSearcher(indexReader);

        String[] fields = {"Name", "UserName", "Text", "Hashtags", "Title","Latitude","Longitude"}; //Add the fields here
